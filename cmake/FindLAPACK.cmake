...
if(${CMAKE_C_COMPILER} MATCHES "icc")
  ...
  if($ENV{MKLROOT} MATCHES "composer")
    ...
    if(mkl_home MATCHES "mkl")
	  ...
	  set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} mkl_intel_lp64 mkl_sequential mkl_core pthread m")
	  set(LAPACK_LIBRARY_DIRS ${mkl_home}/lib/intel64)
        else()
	    ...
	    set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} mkl_intel_lp64 mkl_sequential mkl_core pthread m")
	    set(LAPACK_LIBRARY_DIRS ${mkl_home}/lib/em64t)
          else()
            #link_libraries(-L${mkl_home}/lib/em64t -lmkl_lapack -lmkl -lguide)
	    set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} mkl_lapack mkl guide")
   	    set(LAPACK_LIBRARY_DIRS ${mkl_home}/lib/em64t)
          endif()
        endif()
      endif()
	  ...
	  set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} mkl_intel mkl_sequential mkl_core pthread m")
	  set(LAPACK_LIBRARY_DIRS ${mkl_home}/lib/62)
        else()
	...
	set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} mkl_lapack mkl guide")
	set(LAPACK_LIBRARY_DIRS ${mkl_home}/lib/64)
  ...
  if(${CMAKE_SYSTEM_NAME} MATCHES "AIX")
    set(BLAS_LIBRARIES "${BLAS_LIBRARIES} essl mass massv")
    #link_libraries(-lessl -lmass -lmassv)
    set(BLAS_FOUND TRUE)
  endif(${CMAKE_SYSTEM_NAME} MATCHES "AIX")

  if($ENV{LAPACK} MATCHES "lapack")
    set(LAPACK_LIBRARIES "${LAPACK_LIBRARIES} $ENV{LAPACK}")
  ...
  IF($ENV{ATLAS} MATCHES "atlas")
    ...
    set(LAPACK_FOUND TRUE)
    set(BLAS_FOUND TRUE)
    set(BLAS_LIBRARIES "${BLAS_LIBRARIES} $ENV{ATLAS}")
